...
ordinal_dict={'premium':['important','prem','premium','first','primary','first_class'],'secondary':['secondary','supplement']}
#other words.... 
...
def standarlized_output(Function,input_descript,sector,input_ownership,combined_dict):
    ...
    if func:
        ...
        FUNCTION = str('Function_'+Function)
    sectors= Custom_corpus.sector(sector)
    ...
    return(FUNCTION,descript,sectors,owner,proper)
...
def standarlized_fun(function,combined_dict):
    standard_dict={**combined_dict,**location_dict,**size_dict,**property_function,**ordinal_dict,**relation_dict}
    func = Custom_corpus.find_key(function,standard_dict)
    return(func)

#turn the dictionary to sheet1& sheet2--excel file
